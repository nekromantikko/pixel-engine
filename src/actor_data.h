...
ACTOR_SUBTYPE_REFLECTION_DATA(EFFECT_TYPE_RAIN, EffectData, "rain")
ACTOR_SUBTYPE_REFLECTION_DATA(EFFECT_TYPE_SNOW, EffectData, "snow")
ACTOR_SUBTYPE_REFLECTION_DATA(EFFECT_TYPE_ASH, EffectData, "ash")
ACTOR_SUBTYPE_REFLECTION_DATA(EFFECT_TYPE_FIREFLIES, EffectData, "fireflies")
...
ACTOR_TYPE_REFLECTION_DATA(ACTOR_TYPE_EFFECT, EFFECT_TYPE_NUMBERS, EFFECT_TYPE_EXPLOSION, EFFECT_TYPE_FEATHER, EFFECT_TYPE_RAIN, EFFECT_TYPE_SNOW, EFFECT_TYPE_ASH, EFFECT_TYPE_FIREFLIES)
#pragma endregion
