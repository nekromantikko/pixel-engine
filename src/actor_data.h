...
ACTOR_SUBTYPE_REFLECTION_DATA(EFFECT_TYPE_TILE_DEBRIS, EffectData, "tile_debris")
...
ACTOR_TYPE_REFLECTION_DATA(ACTOR_TYPE_EFFECT, EFFECT_TYPE_NUMBERS, EFFECT_TYPE_EXPLOSION, EFFECT_TYPE_FEATHER, EFFECT_TYPE_TILE_DEBRIS)
#pragma endregion
