...
constexpr u32 NAMETABLE_WIDTH_METATILES = NAMETABLE_WIDTH_TILES / METATILE_DIM_TILES;
constexpr u32 NAMETABLE_HEIGHT_METATILES = NAMETABLE_HEIGHT_TILES / METATILE_DIM_TILES;
...
constexpr u32 VIEWPORT_WIDTH_METATILES = VIEWPORT_WIDTH_TILES / METATILE_DIM_TILES;
constexpr u32 VIEWPORT_HEIGHT_METATILES = VIEWPORT_HEIGHT_TILES / METATILE_DIM_TILES;
