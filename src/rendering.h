...
#define NAMETABLE_SIZE 0x990
#define NAMETABLE_ATTRIBUTE_OFFSET 0x900
#define NAMETABLE_ATTRIBUTE_SIZE 0x90
#define NAMETABLE_WIDTH_TILES 64
#define NAMETABLE_HEIGHT_TILES 36
	struct Nametable {
...
#define VIEWPORT_HEIGHT_TILES NAMETABLE_HEIGHT_TILES
